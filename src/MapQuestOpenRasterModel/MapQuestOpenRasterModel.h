#ifndef Kompas_Plugins_MapQuestOpenRasterModel_h
#define Kompas_Plugins_MapQuestOpenRasterModel_h
/*
...
/** @file
 * @brief Class Kompas::Plugins::MapQuestOpenRasterModel
 */
 ...
 * @brief MapQuest Open
 */
class MapQuestOpenRasterModel: public KompasRasterModel {
    public:
        /** @copydoc Plugins::KompasRasterModel::KompasRasterModel */
        MapQuestOpenRasterModel(PluginManager::AbstractPluginManager* manager = 0, const std::string& plugin = "");
        ...
        inline virtual std::string copyright() const
            { return "©2011 MapQuest - Map data © OpenStreetMap and contributors, CC-BY-SA."; }
